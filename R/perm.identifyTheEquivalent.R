perm.identifyTheEquivalent = function(equal_case, queues, target, dataset, cvar, z, test, wei, threshold, univariateModels, pvalues, hash, dataInfo, stat_hash, pvalue_hash, robust, R, ncores)
{
  z = t(z);
  #case 3
