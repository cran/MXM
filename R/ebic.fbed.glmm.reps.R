ebic.fbed.glmm.reps <- function(y, x, id, reps = NULL, univ = NULL, gam = NULL, wei = NULL, K = 0, test = "testIndGLMMLogistic") { 
  ...
  if ( (con) < 0 )  con <- 0
  lik1 <- BIC( lme4::glmer(y ~ 1 + reps + (1|id), family = oiko, weights = wei) ) 
