---
title: 'Tutorial: Feature selection with the MMPC algorithm from the MXM  R package'
author:
- name: "Christina Chatzipantsiou, Michail Tsagris"
  affiliation: 
...
vignette: >
  %\VignetteIndexEntry{MXM::MMPC Tutorial}
...
## `MMPC()` output: The `mmpc_object` and the feature signature
...
```
#________________ TESTS WITH PERMUTATIONS:  ________________
