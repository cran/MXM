...
## ---- eval = FALSE-------------------------------------------------------
#  
#  #_______________ OVERVIEW of the MXM::MMPC() FUNCTION _______________
#  
#  mmpc_object_default <- MXM::MMPC(target,             # The target variable vector
...
library('MXM')
mmpc_GridSearch <- MXM::mmpc.path(target  = target_NonFlav,            
                                  dataset = wine_dataset  ,            
                                 
                                  max_ks = c(3,4,5,6),         #  a vector of k to try
                                  alphas = NULL  ,          #  a vector of thresholds; If NULL, the values 
                                                               #  (0.1, 0.05, 0.01) will be tested.
                                  test = 'testIndFisher',   
                                  ncores = 1)
...
mmpc_model_wine_NonFlav<- mmpc.model(target = target_NonFlav, 
                                                 dataset = wine_dataset,
                                                 wei = NULL, 
...
mmpc_model_wine_NonFlav$signature
